...
const defaultPublicPath = 'projects/ios-vs-android/audio/intro-voiceover.mp3';
const generatedModulePath = 'src/projects/ios-vs-android/generated/introVoiceoverAsset.ts';
