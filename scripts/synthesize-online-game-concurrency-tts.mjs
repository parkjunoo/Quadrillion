...
const defaultSsml = [
  '<speak>',
  'All-Time Game Rankings,',
  '<break time="120ms"/>',
  'Which One Did You Play?',
  '</speak>',
].join('');

const defaultPublicPath = 'projects/online-game-concurrency/audio/intro-voiceover.mp3';
const generatedModulePath = 'src/projects/online-game-concurrency/generated/introVoiceoverAsset.ts';
