...
const defaultPublicPath = 'projects/world-cup-hosting-costs/audio/intro-voiceover.mp3';
const generatedModulePath =
  'src/projects/world-cup-hosting-costs/generated/introVoiceoverAsset.ts';
...
const speakingRate = Number(args['speaking-rate'] ?? process.env.GOOGLE_TTS_SPEAKING_RATE ?? 1.08);
