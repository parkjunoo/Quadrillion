...
const defaultSsml = [
  '<speak>',
  "When did China's stock market become number two?",
  '</speak>',
].join('');

const defaultPublicPath = 'projects/country-stock-market-cap/audio/intro-voiceover.mp3';
const generatedModulePath =
  'src/projects/country-stock-market-cap/generated/introVoiceoverAsset.ts';
...
const speakingRate = Number(args['speaking-rate'] ?? process.env.GOOGLE_TTS_SPEAKING_RATE ?? 1.04);
